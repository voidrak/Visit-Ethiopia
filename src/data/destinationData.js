const destinationData = [
...

  {
    ...
    description:
      "a historic city nestled in northern Ethiopia, is an intriguing tourist destination that takes visitors on a journey back in time. Known for its ancient archaeological sites and religious significance",
    img: "axumpng.png",
    category: "Near by",
  },
  {
  ...
  },
  {
    ...
    description:
      "a remarkable tourist destination that transports visitors back to the grandeur of Ethiopia's imperial past. This UNESCO World Heritage site showcases a collection of royal castles, palaces, and churches.",
    img: "fasil.png",
    category: "Null",
  },
  {
    ...
    description:
      "a holy city in northern Ethiopia, is an awe-inspiring tourist destination renowned for its extraordinary rock-hewn churches. Carved out of solid rock, these 12th-century churches represent a remarkable feat ",
    img: "Lalibela.png",
